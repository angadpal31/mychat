...
import { View, Text, TouchableOpacity, TextInput, StyleSheet, ToastAndroid, ScrollView, Image, ImageBackground } from 'react-native';
...
class Register extends Component {
    ...
    render() {
      ...
      <Text style={styles.text}>Inside</Text>
              ...
              <Text style = {styles.logo}>ChatAppp</Text>
